...
void GameController::loadResources() 
{
    ...
    //Buttons
    zoomButtonIn = new Button(0.85 * gv->getScreenWidth(), 0.4 * gv->getScreenHeight(), 200, 50, {0, 128, 255, 255}, "Zoom In", gv->getRenderer(), gv->getFont(), std::bind(&GameController::onZoomButtonClickIn, this)); 
    buttonList.push_back(zoomButtonIn);

    zoomButtonOut = new Button(0.85 * gv->getScreenWidth(), 0.45 * gv->getScreenHeight(), 200, 50, {0, 78, 255, 255}, "Zoom Out", gv->getRenderer(), gv->getFont(), std::bind(&GameController::onZoomButtonClickOut, this));
